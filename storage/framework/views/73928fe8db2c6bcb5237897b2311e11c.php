...
<?php if(optional(auth()->user())->role == 111 || optional(auth()->user())->media == 'media'): ?>
   ...
   <div class="row">
        <div class="col-lg-12">
            ...
            <form class="user" action="<?php echo e(url('/dashboard/media')); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\admin\media\create.blade.php ENDPATH**/ ?>