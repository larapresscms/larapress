...
<?php if(optional(auth()->user())->role == 111 || optional(auth()->user())->feedbacks == 'feedbacks'): ?>
   ...
   <div class="row">
        <div class="col-lg-12">
            ...
            <?php echo Form::open(['url' => '/dashboard/categories/'.$categories->id,'method'=>'patch']); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\admin\feedbacks\edit.blade.php ENDPATH**/ ?>