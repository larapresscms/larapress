...
<head>
    ...
    <title> <?php echo e($settingsAdmin->site_title ?? 'None'); ?> </title>
                  ...
                  <?php echo e(csrf_field()); ?>
                      ...
                      <div class="form-group row">
                          <div class="col-sm-12 mb-3 mb-sm-0 text-center">
                              <label class=newbtn>
                                  <img id="blah" src="<?php echo e(asset('public/admin/img/dummy-image-square.jpg')); ?>" >
              ...
              <?php $__currentLoopData = $medies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($cunt <= 12): ?>
                  <div class="col-md-3"> 
                      ...
                      ?>
                          <img src="<?php echo e(asset('public/uploads/images/')); ?>/<?php echo e($media->img_name); ?>" style="width:100%; height:200px" class="img-thumbnail" onclick="changeValue('<?php echo e(asset('public/uploads/images/')); ?>/<?php echo e($media->img_name); ?>', '<?php echo e($media->img_name); ?>')"/>
                      <?php 
                      }
                      ?>
                        
                      <!-- <img src="<?php echo e(asset('public/images/')); ?>/<?php echo e($media->img_name); ?>" class="img-thumbnail" onclick="changeValue('<?php echo e(asset('public/images/')); ?>/<?php echo e($media->img_name); ?>', '<?php echo e($media->img_name); ?>')"/> -->
                    
                      <!-- Tooltip----- -->
                      <span class="input">
                        <input type="text" class="btn-block btn100" id="afInput<?php echo e($media->id); ?>" value="<?php echo e(asset('public/uploads/images/')); ?>/<?php echo e($media->img_name); ?>" readonly>
                      </span>
                      <!-- <div class="tooltip-af">
                          <button class="btn btn-primary btn-user btn-block btn100" onclick="afTooltipFunction<?php echo e($media->id); ?>()" onmouseout="afoutFunc<?php echo e($media->id); ?>()" class="button-ffu">
                            <span class="tooltiptext<?php echo e($media->id); ?>" id="afTooltip<?php echo e($media->id); ?>">Copy to clipboard</span> 
                            </button>
                      </div> 

                      <script>
                        // Tooltip-----
                        function afTooltipFunction<?php echo e($media->id); ?>() {
                          var copyText = document.getElementById("afInput<?php echo e($media->id); ?>");
                          copyText.select();
                          copyText.setSelectionRange(0, 99999);
                          navigator.clipboard.writeText(copyText.value);
                          
                          var tooltip = document.getElementById("afTooltip<?php echo e($media->id); ?>");
                          tooltip.innerHTML = "Copied: " + copyText.value;
                        }

                        function afoutFunc<?php echo e($media->id); ?>() {
                          var tooltip = document.getElementById("afTooltip<?php echo e($media->id); ?>");
              ...
              var html = `<div class="col-md-3 ${item.id} contentnew"> 
                  ...
                  <label for="${item.id}" class="labelMedia">
                      ...
                      ${item.img_name.split('.').pop() === 'pdf' ?
                          `<a class="btn btn-info bbtn"><i class="fas fa-file-pdf"></i></a>` :
                          `<img src="<?php echo e(asset('public/uploads/images/')); ?>/${item.img_name}" style="width:100%; height:200px" class="img-thumbnail" onclick="changeValue('<?php echo e(asset('public/uploads/images/')); ?>/${item.img_name}', '${item.img_name}')"/>`
                      }
                  </label>
                  <span class="input">
                    <input type="text" class="btn-block btn100" id="afInput${item.id}" value="<?php echo e(asset('public/uploads/images/')); ?>/${item.img_name}" readonly>
                  </span>
              </div>
              `; 
...
</html><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\admin\media\mediamanager.blade.php ENDPATH**/ ?>