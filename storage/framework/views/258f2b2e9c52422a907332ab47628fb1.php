...
<div class="wrapper">
  <div class="content clearfix">
    ...
    <header class="site clearfix">
      <div class="col one">
        <img src="<?php echo e(asset('public/admin/img/larapress.png')); ?>" alt="591 Systems" width="740" height="729" id="logo-v" />
      </div>
      <div class="col two">
        <h4>LaraPress (tm) <br /> <b>H</b>euristically <b>E</b>ncrypted <b>R</b>ealtime <b>O</b>perating <b>S</b>ystem (HEROS)</h4>
        <p>----------------------------------------</p>
        <p>Current LaraPress CMS v<?php echo e($CurrentLaraPressVersion ?? "Not Available"); ?></p>
        <p>(c)2021 - <?php echo e(date('Y')); ?> LaraPress CMS</p>
...
<?php if($lara_status == true): ?>
    <p class="text-dark">Welcome to LaraPress CMS (Content Management System)</p>
    <p class="text-dark"><?php echo e($lara_version); ?></p>

<?php if($lara_version !== 'LaraPress is up-to-date.'): ?>
    <p class="clear"><br /></p>
    <p class="text-dark">Are you sure to update your system?</p><br />
    <form action="<?php echo e(route('update-larapress')); ?>" method="GET">     
        <?php echo csrf_field(); ?>
        <button type="submit" class="btn btn-primary">Install Update</button>
        <a class="btn btn-primary" alt="" href="<?php echo e(url('/dashboard/about')); ?>">Cancel</a>
    </form>    
    <p class="clear"><br /></p>        
    <div id="update_status" class="scrollable-div">
        Waiting for update...        
    </div>
    <a href="<?php echo e(url('/dashboard/about')); ?>" class="d-none" id="havefaun">LaraPress successfully updated!! click hare.</a>
        <script>
            $(document).ready(function() {
            pollStatus();           

            function pollStatus() {
                $.get('<?php echo e(url('/update-status')); ?>', function(response) {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\admin\update.blade.php ENDPATH**/ ?>