    ...
    <div class="about-feature-icon-area section-space--inner--60 secend-bg">
            <div class="container">
                <div class="row">
                    ...
                    <?php if($post->post_type == $posttype->slug && $post->slug == 'about-factory-elegant-spinning-textiles-ltd'): ?> 
                    <?php if(auth()->guard()->check()): ?>
                    <!--toplabel menu -->
                    <style>
                        .topnav {
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($post->post_type == $posttype->slug && $post->slug == 'mission-vission-elegant-spinning-textiles-ltd'): ?> 
        <?php if(auth()->guard()->check()): ?>
        <!--toplabel menu -->
        <style>
            .topnav {
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($post->post_type == $posttype->slug && $post->slug == 'factory-products-and-services-elegant-spinning-textiles-ltd'): ?> 
        ...
        <div class="about-list-content section-space--inner--120 secend-bg">
            ...
            <div class="row">
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($post->post_type == $posttype->slug && $post->slug == 'product-gallery-elegant-spinning-textiles-ltd'): ?> 
            <div class="col-lg-12">
                    ...
                    <div class="common-page-content">
                        ...
                        <div class="brand-logo-grid__wrapper section-space--bottom--50">
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($post->post_type == $posttype->slug && $post->slug == 'partners-clients-elegant-spinning-textiles-ltd'): ?>     
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="icon-info-wrapper">
                        ...
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($post->post_type == $posttype->slug && $post->slug == 'corporate-office-elegant-spinning-textiles-ltd'): ?> 
                        <?php if(auth()->guard()->check()): ?>
                        <!--toplabel menu -->
                        <style>
                            .topnav {
...
<?php echo $__env->make('front.themes.elegant.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\front\themes\elegant\elegant-spinning-textiles-ltd.blade.php ENDPATH**/ ?>