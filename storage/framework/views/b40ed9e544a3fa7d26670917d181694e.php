...
<div class="col-lg-4">
    ...
    <div class="card mb-4">
        ...
        <form action="<?php echo e(url('/feedbacks')); ?>" method="post">
        <?php echo e(csrf_field()); ?>
            ...
            <input type="hidden" name="mailurl" value="<?php echo e(url()->current()); ?>"/>
...
<?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views/front/themes/default/sidebar.blade.php ENDPATH**/ ?>