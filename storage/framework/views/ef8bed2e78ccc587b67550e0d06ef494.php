            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body"> 
                    <div class="form-group">                        
                            ...
                            <img id="myImg" src="<?php echo e($posttype->pt_thumbnail_path == null ? asset('public/admin/img/dummy-image-square.jpg') : asset('public/uploads/images').'/'.$posttype->pt_thumbnail_path); ?>" width="100%" height="auto" data-toggle="modal" data-target="#exampleModalCenter" class="border border-info">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\admin\posttypes\edit.blade.php ENDPATH**/ ?>