    ...
    <div class="about-feature-icon-area section-space--inner--60 secend-bg">
            <div class="container">
                <div class="row">
                    ...
                    <?php if($post->post_type == $posttype->slug && $post->slug == 'about-factory-cassiopea-garments-ltd'): ?> 
                    <?php if(auth()->guard()->check()): ?>
                    <!--toplabel menu -->
                    <style>
                        .topnav {
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($post->post_type == $posttype->slug && $post->slug == 'mission-vission-cassiopea-garments-ltd'): ?> 
        <?php if(auth()->guard()->check()): ?>
        <!--toplabel menu -->
        <style>
            .topnav {
            ...
            <h2 class="common-page-title">PRODUCT GALLERY</h2>
                         ...
                         <div class="team-slider">
                            <div class="swiper-container team-slider__container swiper-container-initialized swiper-container-horizontal">
                                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($post->post_type == $posttype->slug && $post->slug == 'product-gallery-cassiopea-garments-ltd'): ?>
                    ...
                    <div class="common-page-content">
                        ...
                        <div class="brand-logo-grid__wrapper section-space--bottom--50">
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($post->post_type == $posttype->slug && $post->slug == 'partners-clients-cassiopea-garments-ltd'): ?>     
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="icon-info-wrapper">
                        ...
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($post->post_type == $posttype->slug && $post->slug == 'corporate-office-cassiopea-garments-ltd'): ?> 
                        <?php if(auth()->guard()->check()): ?>
                        <!--toplabel menu -->
                        <style>
                            .topnav {
...
<?php echo $__env->make('front.themes.elegant.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xamp\htdocs\git-packagist\larapress\packages\larapress\src\Resources\views\front\themes\elegant\cassiopea-garments-ltd.blade.php ENDPATH**/ ?>