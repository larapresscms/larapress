@extends('front.themes.elegant.layouts.master')@auth()
<!--toplabel menu -->
<style>
    .topnavp {
    	background: #000;
    ...
    <div class="about-feature-icon-area section-space--inner--60 secend-bg">
            <div class="container">
                <div class="row">
                    ...
                    @if($post->post_type == $posttype->slug && $post->slug == 'about-factory-cassiopea-clothing-ltd') 
                    @auth()
                    <!--toplabel menu -->
                    <style>
                        .topnav {
        ...
        @foreach($posts as $post)
        @if($post->post_type == $posttype->slug && $post->slug == 'mission-vission-cassiopea-clothing-ltd') 
        @auth()
        <!--toplabel menu -->
        <style>
            .topnav {
        ...
        <div class="about-responsibility-area section-space--inner--120 grey-bg">
            <div class="container">
                ...
                <div class="row">
                @foreach($posts as $post)
                    @if($post->post_type == $posttype->slug && $post->slug == 'factory-products-and-services-cassiopea-clothing-ltd') 
                    @auth()
                    <!--toplabel menu -->
                    <style>
                        .topnav {
            ...
            <h2 class="common-page-title">PRODUCT GALLERY</h2>
                         ...
                         <div class="team-slider">
                            <div class="swiper-container team-slider__container swiper-container-initialized swiper-container-horizontal">
                                @foreach($posts as $post)
                                @if($post->post_type == $posttype->slug && $post->slug == 'product-gallery-cassiopea-clothing-ltd') 
                    ...
                    <div class="common-page-content">
                        ...
                        <div class="brand-logo-grid__wrapper section-space--bottom--50">
                            <div class="row">
                                ...
                                @foreach($posts as $post)
                                @if($post->post_type == $posttype->slug && $post->slug == 'partners-clients-cassiopea-clothing-ltd')   
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="icon-info-wrapper">
                        ...
                        @foreach($posts as $post)
                        @if($post->post_type == $posttype->slug && $post->slug == 'corporate-office-cassiopea-clothing-ltd') 
                        @auth()
                        <!--toplabel menu -->
                        <style>
                            .topnav {
