...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="{{url('/')}}">
            <img src="{{ getSetting('site_logo') == null ? asset('public/admin/img/larapress.png') : asset('public/uploads/images/').'/'.getSetting('site_logo') }}" alt="@getSetting('site_title')" width="150px">
        </a>
