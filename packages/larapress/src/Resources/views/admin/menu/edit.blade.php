                ...
                <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Menu Icon/Image</h6>  
                            ...
                            <div class="card-body">                    
                                <div class="form-group text-center">                       
                                        <input type="hidden" id="myImg_type" name='icon' placeholder="Image Url" class="form-control" value="{{ $menu->icon }}">
                                        <img id="myImg" src="{{ $menu->icon == null ? asset('packages/larapress/src/Assets/admin/img/dummy-image-square.jpg') : asset('public/uploads').'/'.$menu->icon }}" width="20%" height="auto" data-toggle="modal" data-target="#exampleModalCenter" class="border border-info" data-preview="myImg">                         
                    ...
                    <div class="col-md-4">
                        <div class="card shadow mb-4">
                            ...
                            <div class="mt-3 text-right">
                                <a href="{{ url('/dashboard/menu/create') }}" class="text-white"><button class="btn btn-primary btn-user"><i class="fa fa-plus"></i></button></a>
                            </div>
