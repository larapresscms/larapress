            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    {{ csrf_field() }}
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Create a Menu!</h6>                                                   
                            </div>
                            <div class="card-body">                            
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">                    
                                <div class="form-group text-center">                       
                                        <input type="hidden" id="myImg_type" name='icon' placeholder="Image Url" class="form-control" >
                                        <img id="myImg" src="{{ asset('packages/larapress/src/Assets/admin/img/dummy-image-square.jpg') }}" width="20%" height="auto" data-toggle="modal" data-target="#exampleModalCenter" class="border border-info" data-preview="myImg">
